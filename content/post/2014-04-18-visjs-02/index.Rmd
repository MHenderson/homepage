...
Continuing on from
[an earlier post]({% post_url 2014-03-28-visjs-01 %}),
in
...
blogdown::shortcode("gist", "MHenderson", "10667009", "index.html")
```

```{r, eval=TRUE, echo=FALSE}
blogdown::shortcode("gist", "MHenderson", "10667009", "options.coffee")
```
